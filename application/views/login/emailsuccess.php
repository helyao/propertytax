...
<head>
    ...
    <title>Email Sent Successfully &mdash; PayFairTax</title>
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="#" class="notice-form animate-box" data-animate-effect="fadeIn">
                ...
                <h3><b>Verify your email address to use your account.</b></h3>
                <h3>We sent an email to <b><?php echo $email ?></b> with a link to verify your email address.</h3>
            </form>
        </div>
    </div>
